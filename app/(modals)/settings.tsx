  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* PHOSM - Personal Health Operating System for the Mind */}
        <Text style={styles.sectionTitle}>My PHOSM</Text>
        <Text style={{ fontSize: 12, color: TEXT_DIM, marginBottom: 12, marginHorizontal: 4 }}>
        ...
        <View style={styles.card}>
          ...
          <Pressable
            style={styles.row}
            onPress={() => router.push('/(modals)/phosm-body')}
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Text style={{ fontSize: 24 }}>🫀</Text>
              <View style={{ flex: 1 }}>
                <Text style={styles.rowLabel}>Body Baseline</Text>
                <Text style={styles.rowHint}>Sleep, nutrition, movement needs</Text>
              </View>
            </View>
          ...
          <Pressable
            style={styles.row}
            onPress={() => router.push('/(modals)/phosm-state')}
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Text style={{ fontSize: 24 }}>⚡</Text>
              <View style={{ flex: 1 }}>
                <Text style={styles.rowLabel}>Regulation Map</Text>
                <Text style={styles.rowHint}>Triggers, tools, early warnings</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color={TEXT_MUTED} />
          </Pressable>
          ...
          <Pressable
            style={styles.row}
            onPress={() => router.push('/(modals)/phosm-emotion')}
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Text style={{ fontSize: 24 }}>💛</Text>
              <View style={{ flex: 1 }}>
          ...
          <Pressable
            style={styles.row}
            onPress={() => router.push('/(modals)/foundation-people')}
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Text style={{ fontSize: 24 }}>💜</Text>
              <View style={{ flex: 1 }}>
                <Text style={styles.rowLabel}>Connection Compass</Text>
                <Text style={styles.rowHint}>Your inner circle & intentions</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color={TEXT_MUTED} />
          </Pressable>
          ...
          <Pressable
            style={styles.row}
            onPress={() => router.push('/(modals)/foundation-directions')}
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Text style={{ fontSize: 24 }}>🧭</Text>
              <View style={{ flex: 1 }}>
                <Text style={styles.rowLabel}>Direction Map</Text>
                <Text style={styles.rowHint}>Goals & what you're working toward</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color={TEXT_MUTED} />
          </Pressable>
          ...
          <Pressable
            style={styles.row}
            onPress={() => router.push('/(modals)/foundation-values')}
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Text style={{ fontSize: 24 }}>⚖️</Text>
              <View style={{ flex: 1 }}>
                <Text style={styles.rowLabel}>Values Workshop</Text>
                <Text style={styles.rowHint}>Core values & priorities</Text>
              </View>
            </View>
            <Ionicons name="chevron-forward" size={20} color={TEXT_MUTED} />
          </Pressable>
